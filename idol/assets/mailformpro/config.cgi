...
## フォームの宛先
push @mailto,'katsuwata@a15.co.jp';
push @mailto,'info@bokunanichan.com';
...
$config{'ThanksPage'} = 'https://bokunanichan.com/thanks.php?no=%s';

## 設置者に届くメールの件名
$config{'subject'} = '[ %s ] HPお問い合わせ';
...
$config{"ReturnSubject"} = '[ %s ] お問い合わせありがとうございます。';

## 自動返信メールの本文
$_TEXT{'responder'} = <<'__return_body__';
<_姓_> 様
********************************************
この度は、HPよりご連絡いただきまして誠にありがとうございます。

担当者よりご連絡させていただきますので、今しばらくお待ちくださ。

******************************************** 

「Ω僕たちまた何かやっちゃいました？Ω」
https://bokunanichan.com/
